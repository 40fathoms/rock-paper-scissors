...
const Info = () => {
  ...
  return (
    <>
      ...
      <article
        className={cn([
          'flex flex-col gap-4 bg-gray-800 p-8',
          'transition-transform duration-500 ease-out',
          'sm:h-full sm:overflow-auto sm:px-[10%]',
          'lg:px-[20%]',
      ...
      >
        ...
        <ul>
          ...
          <li>
            The element that &quot;wins&quot; in the interaction causes the
            other element to transform into its type.
          </li>
        </ul>
        <h2>Objective:</h2>
        <p>
